...
public:
    ...
    QPushButton *timelineWindowButton;
    QMenuBar *menuBar;
    QMenu *menuSetMode;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(displayText, 15, 0, 1, 1);
        ...
        gridLayout->addWidget(quitButton, 15, 2, 1, 1);
        ...
        QBrush brush10(QColor(85, 170, 255, 255));
        ...
        timelineWindowButton = new QPushButton(centralWidget);
        timelineWindowButton->setObjectName(QStringLiteral("timelineWindowButton"));
        timelineWindowButton->setCheckable(true);
        timelineWindowButton->setChecked(false);

        gridLayout->addWidget(timelineWindowButton, 14, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        timelineWindowButton->setText(QApplication::translate("MainWindow", "Open Timeline Window", 0));
